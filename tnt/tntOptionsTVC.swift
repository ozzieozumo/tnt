...
//  tnt
//
//  Created by Luke Everett on 12/24/17.
...
class tntOptionsTVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
            ...
            menu.append(Option(
                title: "Debug",
                description: "Admin and Debug",
                icon: nil,
                segueId: "tntOptionDebug"
            ))
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let segueId = menu[indexPath.row].segueId {
